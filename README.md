...
- **Heatmap metric:** Use the layer control and metric selector to display live or historical patterns for mean delay, median delay, delay standard deviation, vehicle density, or speed. Hotter colours indicate greater intensity for the selected metric. Delay distribution metrics apply to historical cells; the live layer shows current per-vehicle lateness.
